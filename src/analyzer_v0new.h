...
// as if the loose tier had never run. Returns candidates in claim order (tight block first, chi2
...
//          binned-fit estimator, descriptive). Remaining cut variables (cosPointing,
